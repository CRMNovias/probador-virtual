 ...
 */
// El login OTP va directo al CRM por marca (/auth/atelier/*). El CRM emite un
// JWT con el claim `brand`, así que el resto de endpoints resuelven la marca
// desde el token. Ya no hay auth-mini.
